...
const PrivacyStatement = () => {
    return (
      <section className="course-overview max-w-[1000px] md:px-0 px-10 mx-auto">
           ...
           <h1 className="font-extrabold py-10 text-5xl text-[#000000] leading-tight">Privacy Statement
           </h1>
       		
				
				
				
        <div className="et_pb_text_inner leading-[33px] space-y-6">
  <p className="text-[18px] text-[#000000]">
  Please know that we are committed to protecting and appropriately handling the private and personal information of users and visitors to this Site.  We are publishing this Privacy Statement to let you know how we handle personal information in this Site.  We may, from time-to-time, update this privacy notice so we encourage you to periodically review this policy.  We will notify you about material changes in the way we treat personal information by placing a notice on our site.  </p>

  <h4 className="text-[18px] text-[#000000] font-bold">
    1. Using this Site.
  </h4>
  <p className="text-[18px] text-[#000000]">
    Please read our <Link href="/terms-of-use/">Terms of Use</Link> (the “Terms of Use”) to find out more about the requirements for using this Site.
  </p>
...
The Site also uses information collected through technology to make the Site more interesting and useful to you.  We normally do not combine this type of information with personally identifiable information.  However, we may combine this information with personally identifiable information to identify a visitor in order to enforce compliance with our Terms of Use, or to protect the Site, interests and reputation, guests, and/or others.  Demographic and profile data may also be collected at the Site.  We can use this data to tailor our visitors’ experience at the Site, showing them content that we think they might be interested in, and displaying the content according to their preferences. </p>
...
You must read the privacy policy of the third party Web site concerning how personal information will be used.  We also provide content created by third-parties on certain of our Sites.  We are not responsible for the privacy practices or the content of such Content Providers or Third-Party Sites. </p>
...
When a child under the age of 13 attempts to register with one of Our Sites, purchase products or materials, or participate in an activity requiring the submittal of personally identifiable information, he or she must  have a parent or guardian provide permission and consent for that child to provide information and register.  The only personally identifiable information we collect from a child is information that is necessary for the child to participate in some activity, such as an address for making a purchase.  We may also collect personal information, like a pet’s name, to help visitors (including children) remember their Log-in Name and password if they forget them. We also allow parents to request at any time that the information collected about their child be removed from our database. 

On certain of our Sites, we occasionally may host or offer access to some chat rooms, or other Forums, where no personally identifiable information is collected or posted.  Children can visit these Forums without having to first provide any personally identifiable information. </p>

  <h4 className="text-[18px] text-[#000000] font-bold">
    9. Opt-In/Opt-Out Communications.
  </h4>
  <p className="text-[18px] text-[#000000]">
  We may provide visitors to the Site the opportunity to register for services such as signing-up to receive updates from certain parts of Our Organization.  Visitors are not obligated to register for these services.  Also, you can unsubscribe from any electronic communications from Our Organization. Please contact us to request that we no longer contact you via e-mail or other means using the personal information you have provided at any of the Site. </p>
  ...
  <p className="text-[18px] text-[#000000]">
  A link named “Contact” may be provided on pages of Our Site.  Please click on this link to send an e-mail to Our Organization’s support staff and we will work to ensure your query is answered or passed on to the appropriate person in a timely manner. </p>

  <h4 className="text-[18px] text-[#000000] font-bold">
    12. Your California Privacy Rights.
  </h4>
  <p className="text-[18px] text-[#000000]">
  Beginning January 1, 2005 under California’s “Shine the Light” law, California residents who provide personal information in obtaining products or services for personal, family or household use are entitled to request and obtain from us once a calendar year information about the customer information we shared, if any, with other businesses for their own direct marketing uses. If applicable, this information would include the categories of customer information and the names and addresses of those businesses with which we shared customer information for the immediately prior calendar year (e.g. requests made in 2005 will receive information regarding 2004 sharing activities).  Please be aware that not all information sharing is covered by the “Shine the Light” requirements. </p>
</div>
