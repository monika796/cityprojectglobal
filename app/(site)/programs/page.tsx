  ...
  console.log(data);
    return (
        <main className="md:w-[100%] mx-auto"> 
                  ...
                  <Image  src="/85.png" className=" mx-auto p-2 md:p-0" alt="" / width="200" height="200" />
                  <div className="md:flex pt-5 ">
                    ...
                    <div className="md:absolute bottom-[5%]"> <p className="text-[16px] text-[#000000] italic font-normal leading-[24px] text-center md:text-left">{data.page.programpagefeild.secondSectionLeftColumn} </p>
                        ...
                        <Image  src="/108.png" className=" pt-5 md:m-0 mx-auto" / width="200" height="200" />
                        </div></div>
                    <div className="md:w-3/5 p-10">
                        ...
                        <a href={data.page.programpagefeild.secondSectionRightButtonLink} className=" mx-auto md:mx-0 flex  items-center gap-2.5 w-[fit-content] inline-block mt-4 bg-[#A1CF5F] font-bold text-black text-sm py-3 px-6 rounded-lg transition duration-300">{data.page.programpagefeild.secondSectionRightButtonText} <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" id="arrow"><g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M1 13 13 1M4 1h9v9"></path></g></svg></a>
                                               
                          </div>
                  </div>
                  <div className="md:absolute hidden md:block top-[45%] left-5  pt-50 p-2 bg-[#A1CF5F]">
                    <Image  src='/84.png' alt="" / width="200" height="200" />
                ...
                <div className="md:flex pt-9 gap-10">
                  <div className="md:w-4/12  ">
                    <h4 className="text-[20px] pb-10 md:w-[75%] text-center md:text-left text-white md:leading-[29.09px] "> {data.page.programpagefeild.thirdSectionLeftText}</h4>
                      <Image  src='106.png'  className=' md:m-0 mx-auto md:p-0 p-5'  alt='' / width="200" height="200" />
                  </div>
                  ...
                  {data.page.programpagefeild.third_section_right_columns.map((dataposts, index) => (
                      ...
                      <div key={index} className="bg-white rounded-[5px] w-[100%] mb-3 md:mb-0">
                              ...
                              <div className="w-1/4">
                                <Image  src='/104.png'    alt="" / width="200" height="200" />
                              </div>
                              <div className="w-3/4">
                              <Image  src={dataposts.columnimages_program?.node?.link} className="mx-auto" alt="" / width="200" height="200" />
                              </div>
                             ...
                             <a href={dataposts.button_link_program}> <button className="  mt-[21px]  md:mt-0 flex items-center gap-3 text-black bg-[#A1CF5F] font-bold p-2 rounded-[5px]">{dataposts.button_text_program}<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" id="arrow">
