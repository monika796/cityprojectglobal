                ...
                <div className="md:flex pt-9 gap-10">
                  ...
                  {data.page.programpagefeild.third_section_right_columns.map((dataposts, index) => (
                      ...
                      <div key={index} className="bg-white rounded-[5px] w-[100%] mb-3 md:mb-0">
                             ...
                             <Link href={dataposts.button_link_program}> <button className="  mt-[21px]  md:mt-0 flex items-center gap-3 text-black bg-[#A1CF5F] font-bold p-2 rounded-[5px]">{dataposts.button_text_program}<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" id="arrow">
