...
export default function Programs() {
    return (
        <main className="md:w-[91%] mx-auto"> 
                    <h1 className="md:py-[42px] pt-4 py-[30px] md:text-[64px] text-[25px] font-bold text-center text-black md:w-[52%] p-5 mx-auto md:leading-[77px] ">Unlock Your Purpose
                  ...
                  <div className="md:flex pt-5 ">
                    ...
                    <div className="md:w-3/5 p-10">
                        ...
                        <h4 className="pt-[25px] pb-10 text-[#000000] text-[16px] font-bold leading-[23px] md:w-[50%] text-center md:text-left">Join the Leadership Circle: A 9-Month Journey to Discover Your Calling, Strengthen Your Faith, and Bring Restoration to Your City</h4>
               ...
               <section className="container  max-w-[1480px]  bg-[#000000] mx-auto">
                ...
                <h1 className="md:text-[48px] text-[35px] md:w-[60%] font-bold text-white text-center md:text-left leading-[38px] md:leading-[58.09px] ">Transformative Programs for Leaders Empowering You to Impact Cities and Communities</h1>
                <div className="md:flex pt-9 gap-10">
                  <div className="md:w-4/12  ">
                    <h4 className="text-[20px] pb-10 md:w-[75%] text-center md:text-left text-white md:leading-[29.09px] ">Our programs empower leaders to make a meaningful impact on cities and communities through deep engagement with faith and purpose.</h4>
                  ...
                  <div className="md:w-8/12 md:flex gap-5">
                      <div className="bg-white rounded-[5px] w-[100%] mb-3 md:mb-0">
                              ...
                              <h5 className="text-[10px] md:text-[16px] text-[#000000] uppercase md:pb-2 font-bold">Flagship Program</h5>
                              <h3 className="text-[20px] md:text-[32px] text-[#000000] md:pb-10 font-bold">Leadership Circle</h3>
                      ...
                      <div className="bg-white rounded-[5px] md:w-[100%]">
                               ...
                               <div className="px-5 py-5">
                               <h5 className="text-[10px] md:text-[16px] text-[#000000] uppercase md:pb-2 font-bold">A Small Group Discovery Series</h5>
                               <h3 className="text-[20px] md:text-[32px] text-[#000000] md:pb-10 font-bold">VantagePoint™</h3>
                               <button className=" mt-[21px] md:mt-0 flex items-center gap-3 text-black bg-[#A1CF5F] font-bold p-2 rounded-[5px]">Learn More<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" id="arrow">
                                 <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
                                   <path d="M1 13 13 1M4 1h9v9"></path>
                                 </g>
