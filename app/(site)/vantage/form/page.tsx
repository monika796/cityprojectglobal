...
<div className="container mx-auto max-w-[1480px]">
   <div className="main-heading py-10">
      <div className="flex items-center justify-between flex-wrap gap-5">
         <h2 className="m-0 text-[32px]  md:text-[64px]  text-black font-bold"> {data.page.vantageForm.vantageFormMainHeading} </h2>
   ...
   <section>
      <div className="grid grid-cols-1 md:grid-cols-3">
         <Image  width={2000} height={2000} src={data.page.vantageForm.vantageFormSecondSectionFirstColumnImage?.node?.link} className="object-cover object-right xl:h-[363px]" alt="Vantage Image 1" />
         <div className="middle-content bg-[#263519] p-4 xl:p-8">
            <h2 className="font-anton text-[#A1CF5F] md:mb-0 mb-5 text-[32px] md:text-[30px] xl:text-[60px] font-medium leading-[50px] xl:leading-[97.3px]"> {data.page.vantageForm.vantageFormSecondSectionSecondColumnPrice} </h2>
            <h3 className="font-anton text-[30px] md:text-[30px] xl:text-[55px] font-medium text-white leading-[40px] xl:leading-[88.96px]"> {data.page.vantageForm.vantageFormSecondSectionSecondColumnHeading}</h3>
         ...
         <Image  width={2000} height={2000} src={data.page.vantageForm.vantageFormSecondSectionThirdColumnImage?.node?.link} className="object-cover object-center xl:h-[363px]" alt="Vantage Image 2" />
      </div>
   </section>
    <SecondSection />
<section>
