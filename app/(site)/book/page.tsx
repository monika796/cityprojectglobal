    ...
    return (
        <main className="md:w-[91%]   mx-auto">
            ...
            A Guide to Integrating Faith, Work, and Community</h1>
              ...
              <h1 className={`${anton.className} text-[30px] font-normal  text-center text-[#000000] leading-[40px] w-[90%] md:w-[57%] mx-auto`}>
            ...
            <div className="container mx-auto">
                  <section className="md:py-[32px] ">
                        ...
                        <div className="relative mx-auto table"> 
                            ...
                            <div className="md:absolute bottom-3 p-5 text-center md:text-left">
                                <h2 className="md:text-[45px]  text-[30px] font-bold text-black md:text-white md:w-[32%] leading-[49px]">About the Book </h2>
                  ...
                  <div className="container mx-auto md:py-15">
                    <h2 className="font-bold text-black md:text-left text-center  md:w-[40%] md:text-[33px] text-[25px] leading-tight mb-4">Bridging the Sacred-Secular Divide Reclaiming the Integration of Faith and Work</h2>
                   <div className="md:flex">
                    ...
                    <div className="md:w-1/2 p-3">
                            <p className="font-normal text-[15px]  text-center md:text-left text-black pt-2 pb-3">
                            ...
                            </p><p  className="font-normal text-[15px]  text-center md:text-left text-black  pb-3 ">
...
The call to return to God’s design is desperately needed, a message  that can transform communities, cities, and nations. The book you hold  in your hands is compact, memorable, and rich in wisdom. Properly  applied, it can unlock a wonderful new freedom to be all God intended  for you personally and for your work.”
                            ...
                            <h5 className=" text-[15px]  text-center md:text-left text-black font-bold pb-3">
                ...
                <div className="container mx-auto md:py-15">
                    <div className="md:flex">
                        ...
                        <h2 className="font-bold text-black text-center md:text-left   text-[33px] leading-tight mb-4">Taking Your Whole Self to Work</h2>
                        <p className="font-normal  text-center md:text-left text-[14px]  text-black pb-3">Have you ever felt like your work has no meaning? Or like faith and  daily life fall into separate days of the week and modes of being? Or  like the only valid contribution you have toward kingdom building is  tithing, evangelizing, or working in ministry?</p>
