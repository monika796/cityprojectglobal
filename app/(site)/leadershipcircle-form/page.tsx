...
const MainForm = () => {
            ...
            const response = await axios.post(
              ...
              data,
              {
                headers: {
                  ...
                  'Authorization': `Basic ${btoa('ck_3b900686e6b6f05a64b49ff09163b1ae35017710:cs_a366847ab722d30837123aac4605cc07c1eeaac1')}`,
                },
              }
            );
    ...
    return (
        <div className='container py-10 grid gap-8  md:max-w-[900px] mx-auto'>
            ...
            <div className=''>
                <h2 className='text-[40px] text-[#000000] font-bold'> Leadership Circle</h2><br className='hidden md:block'/>
                <p className='text-[20px] text-[#000000]'>Thank you for your interest in participating in the Leadership Circle. Fill out this initial application and we will be in contact soon.</p>
            </div>
          ...
          <p className="text-black text-[16px]">
            ...
            <div className='flex flex-wrap gap-x-2'>
                <button
                    ...
                    className={`px-7 py-2  bg-[#a1cf5f] rounded text-black font-bold ${activeTab === 0 ? "hidden opacity-50 bg-slate-600" : "opacity-100"}`}>
                    Back
                </button>
                <button
                    disabled={activeTab === formElements.length - 1}
                    onClick={handleNext}
                    className={`px-7 py-2  bg-[#a1cf5f] rounded text-black font-bold ${activeTab === formElements.length - 1 ? " hidden opacity-50 bg-slate-600" : "opacity-100"}`}>
                    Next
                </button>
