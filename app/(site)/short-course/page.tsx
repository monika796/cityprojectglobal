...
<main className="">
      ...
      <div className=" relative flex flex-wrap md:flex-nowrap bg-[#EEF0EB]">
         <div className="md:w-1/3 w-full p-8  relative mx-auto">
            <div className="md:absolute relative bottom-0 md:bottom-10 ">
               <h2 className="text-black w-full md:w-[70%] md:mb-0 mb-10 text-[20px] leading-[30px]">{shortcourse.shortCoursesFirstSection.shortCoursesFirstSectionFirstColumnText}</h2>
               <Link
         ...
         <div className="relative w-full md:w-7/12">
            ...
            <Image src={shortcourse.shortCoursesFirstSection.shortCoursesFirstSectionSecondColumnUpperImage?.node?.link} height={1000} width={1000} alt="" className="relative md:absolute w-[30%] top-0 left-[-100px]"/>
         </div>
         <div className="md:w-5/12 w-full grid gap-10 ">
            <div className="bg-[#000000] relative md:absolute w-full md:w-[373px]  mr-7 -top-30 p-9 rounded-lg border-b-[20px] border-[#A1CF5F]">
               ...
               {shortcourse.shortCoursesFirstSection.shortCoursesFirstSectionThirdColumnDescription}</p>
               <Image src={shortcourse.shortCoursesFirstSection.shortCoursesFirstSectionThirdColumnImage?.node?.link} height={1000} width={1000} alt="" className="w-[35%] py-3 " />
            </div>
         </div>
      </div>
      </div>
   ...
   <section className="flex flex-wrap md:flex-nowrap py-20 container mx-auto max-w-[1480px]">
      ...
      <div className="md:w-2/3 w-full p-8 gap-10 grid">
         ...
         {shortcourse.shortCoursesSecondSection.shortCoursesSecondSectionSecondColumnBottomFeilds.map((stat, index) => (
        <div
          key={index}
          className="md:w-1/3 w-full m-3 border-t border-gray-500 p-3 md:p-6"
        >
          ...
          <p className="text-[20px] text-black leading-[60px]">{stat.shortCoursesSecondSectionSecondColumnBottomFeildsDescription}</p>
        </div>
      ))}
         </div>
      </div>
      ...
      <div className="" >
         <div className="flex flex-wrap md:flex-nowrap" >
            <div className="w-full md:w-1/2 grid gap-10" >
               ...
               {shortcourse.shortCoursesThirdSection.shortCoursesThirdSectionMainFirstRowHeading} </h2>
            </div>
            <div className="w-full md:w-1/2 md:mt-20 mt-8" >
               <h4 className="text-[16px] w-full md:w-[50%] float-right text-white">
               {shortcourse.shortCoursesThirdSection.shortCoursesThirdSectionMainFirstRowDescription} </h4>
            </div>
         </div>
         <div className=" py-20">
            <div className="flex flex-wrap md:flex-nowrap">
   ...
   <section className="md:py-20 py-0 md:mt-0 mt-10 container mx-auto max-w-[1480px]">
      <Image src= {shortcourse.shortCoursesFourthSection.shortCoursesFourthSectionImage?.node?.link} alt="" className="mx-auto w-full md:w-[40%]" width={1000} height={1000} />
      <div className=" py-15 md:w-[70%] w-full mx-auto " >
         ...
         {shortcourse.shortCoursesFourthSection.shortCoursesFourthSectionHeading}</h2>
      </div>
   ...
   <section className="mx-auto md:py-30 py-10 my-20 container max-w-[1480px]   bg-[#F5F5F5]">
      ...
      <h2 className={`${anton.className} uppercase mx-auto pb-3 text-center w-full md:w-[46%] text-black text-[26px] md:text-[50px] font-bold  leading-[40px] md:leading-[60px]`} >
      {shortcourse.shortCoursesFifthSection.shortCoursesFifthSectionReview}</h2>
      <h4 className="text-[20px] text-center font-bold text-black"  >{shortcourse.shortCoursesFifthSection.shortCoursesFifthSectionText}
      </h4>
