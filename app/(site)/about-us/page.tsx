  ...
  return (
    <main className="md:w-[100%] mx-auto bg-white">
      <h1 className="md:max-w-[1178px] md:py-[42px] mt-4 py-[30px] md:text-[58px] text-[25px] leading-[38px]  font-bold  md:leading-[77px] text-center text-black  p-5 mx-auto md:leading-[77px] ">
        {data.page.aboutuspage.mainheadingabout}
      </h1>
      ...
      <div className="container mx-auto max-w-[1480px]">
        {' '}
        <section className="md:flex md:gap-20 md:py-[32px] ">
          <div className="md:w-2/3 ">
            ...
            <div className="p-7 md:flex gap-15 md:pt-20">
              <div className=" md:w-2/5">
                <Image
                  src={
                    data.page.aboutuspage.secondsectionimagwithtext_image?.node
                      ?.link
                  }
                  alt=""
                  alt=""
              ...
              <div className=" md:w-3/5 pt-3">
                ...
                <a
                  href={
                    data.page.aboutuspage.secondsectionimagwithtextButtontext
                  }
                  className="md:mt-8 flex   mx-unset md:mx-0 items-center gap-2.5 w-[fit-content] inline-block mt-4 bg-[#A1CF5F] font-bold text-black text-sm py-3 px-6 rounded-lg transition duration-300"
                >
                  {data.page.aboutuspage.secondsectionimagwithtextButtontext}{' '}
                  <svg
        ...
        <section className=" md:pt-10 py-[32px]">
          <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
            <div className="grid grid-cols-2  pt-[29px] md:grid-cols-7 md:justify-center">
              {data.page.aboutussections.iconsections.map(
                (dataposts, index) => (
                  <div
      ...
      <div className="container mx-auto max-w-[1480px]">
        <section className="md:flex pt-[32px] grid">
          ...
          <div
            className="md:w-1/2 order-1 bg-[#d3d3d3] md:h-auto h-[350px] w-auto   bg-contain bg-no-repeat bg-bottom   "
            style={{
              backgroundImage: `url('${data.page.aboutussections.imagewithtextImage1?.node?.link}')`,
            }}
          >
      ...
      <div className="container mx-auto max-w-[1480px]">
        <section className="md:flex pb-[32px]">
          <div
            className="md:w-1/2 bg-contain bg-[#d3d3d3] md:h-auto h-[350px] w-auto bg-no-repeat bg-bottom  "
            style={{
              backgroundImage: `url('${data.page.aboutussections.imagewithtextImage2?.node?.link}')`,
            }}
          >
            <div className="border border-white m-[6px] w-[98%] h-[97%] relative "></div>
          </div>
      ...
      <div className="container mx-auto max-w-[1480px]">
        ...
        <section className="mx-auto grid gap-[37px] pt-[100px] pb-[100px] ">
          ...
          <h4
            className={`${anton.className} text-[18px] md:text-[32px] font-normal  text-center text-[#aed575]`}
          >
        ...
        <section className="bg-[#F5F5F5] p-[34px]  md:pt-[0px]">
          <div className="md:flex">
            ...
            <div className="md:w-[60%] md:pl-10 md:pr-10 md:pt-0 pt-20 relative">
              <Image
                src={
                  data.page.aboutussections.tenthsectionrightimage?.node?.link
                }
                className="mx-auto"
                alt=""
                width="200"
              ...
              />
              <div className="md:flex ">
                {data.page.aboutussections.tenthsectionrightcolumns.map(
                  (slide, index) => (
                    <div className="md:w-1/3 p-10 grid gap-10 " key={index}>
                      <Image
                        ...
                        height="200"
                      />
                      <h5 className="text-black text-[18px] md:text-left text-center">
                        {slide.columnstext}
                      </h5>
                    </div>
                  )
      ...
      <div className="container mx-auto max-w-[1480px]">
        <section className="mx-auto grid gap-[37px] md:p-0 p-8 md:pt-[100px] md:pb-[50px] ">
          ...
          <h4
            className={` text-[16px] font-normal  mx-auto  md:w-[40%] text-[#000000]  text-center md:text-left`}
          >
            {' '}
          ...
          <h4
            className={` text-[16px] font-normal  text-center md:text-left  mx-auto  md:w-[40%] text-[#000000] `}
          >
      ...
      <div className="container mx-auto md:mt-10 max-w-[1480px]">
        <section className="md:flex w-[80%] mx-auto pb-[30px] md:pb-[170px]">
          <div className="md:w-1/2 ">
            <Image
              src={data.page.aboutussections.twelthsectionleftimage?.node?.link}
              alt=""
              width="200"
              height="200"
            />
          ...
          <div className="md:w-1/2 grid gap-5">
            <Image
              src={
                data.page.aboutussections.twelthsectionrightimage?.node?.link
              }
              alt=""
            ...
            <h4
              className={` text-[15px] font-normal  text-center md:text-left text-[#000000] md:order-3`}
            >
              {' '}
