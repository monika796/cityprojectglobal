                      ...
                      <hr />  
                                  ...
                                  <div className="p-7 md:flex gap-15 md:pt-20">
                                    ...
                                    <div className=" md:w-3/5 pt-3">
                                      ...
                                      <div  className="md:mt-8 flex max-w-max  mx-unset md:mx-0 items-center gap-2.5 w-[fit-content] inline-block mt-4 bg-[#A1CF5F] font-bold text-black text-sm py-3 px-6 rounded-lg transition duration-300">
