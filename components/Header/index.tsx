        ...
        <div className="flex w-full items-center justify-between xl:w-1/4">
          <Link href="/" onClick={closeNavigation} >
            <Image
              // src="/1 1.png"
              src={
                isHomePage && isDesktop || stickyMenu && !isMobile  ? "/1 1.png" : "/logo.png"
              }
              alt="logo"
              width={80}
              height={46}
...
>
  ...
  <svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M8.78609 9.33674H6.20974V17.5634H2.39045V9.33674H0.573242V6.11862H2.39045V4.03562C2.39045 2.54554 3.10239 0.212891 6.24514 0.212891L9.07716 0.224593V3.34909H7.02395C6.68568 3.34909 6.21368 3.51682 6.21368 4.22676V6.12252H9.12436L8.79003 9.34064L8.78609 9.33674Z" fill={isHomePage ||  stickyMenu   ? "white" : "#000000"} />
  </svg>
</Link>
...
<Link 
  ...
  onClick={closeNavigation}
>
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 56.7 56.7" fill={isHomePage ||  stickyMenu   ? "white" : "#000000"}>
    <g>
