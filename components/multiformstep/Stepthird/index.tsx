...
const Address = (props) => {
    ...
    return (
        <form className="w-full mx-auto rounded pt-6 pb-8 mb-4">
            ...
            <div className="py-3">
                <label className="block text-gray-700 text-sm font-bold mb-3">
                    Which sphere(s) of society do you sense God's call on you to influence? (check all that apply) <span className='text-[#ff0000]'>*</span>
                </label>
                <div className="space-y-2">
                    {['Family', 'Economics', 'Government', 'Religion', 'Education', 'Media/Communications', 'Celebration (arts, entertainment, and sports)'].map((sphere) => (
                        
                        <div className="flex items-center space-x-2" key={sphere}>
                            <input
                            ...
                            />
                            <label className="text-black">{sphere}</label>
                        </div>
                    ))}
